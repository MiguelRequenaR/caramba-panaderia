  ...
  return (
    <section data-aos="fade-up" data-aos-delay="100">
      <div className="mb-6 flex flex-col md:flex-row md:justify-between items-center space-y-4 md:space-y-0">
        <div>
          <h2 className="text-3xl font-bold text-secondary mb-2">Productos</h2>
      ...
      {isModalOpen && (
        ...
        >
          <div 
            className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto mt-[500px]"
