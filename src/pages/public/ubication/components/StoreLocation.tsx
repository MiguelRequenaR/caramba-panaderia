    ...
    className="py-20 bg-[#f8f7ee]">
      ...
      className="max-w-7xl mx-auto">
        ...
        className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          data-aos="fade-up"
          data-aos-delay="200">
            <img src="https://images.unsplash.com/photo-1643944471768-2d2eac3afb6d?q=80&w=1174&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Panadería y Pastelería" className="w-full h-full object-cover rounded-xl" />
          </div>
        </div>
        <div
        className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-30">
          ...
          data-aos="fade-right"
          data-aos-delay="300">
            <img src="https://images.unsplash.com/photo-1586812314139-d1b0ca32cbab?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Panadería y Pastelería" className="w-full h-full object-cover rounded-xl" />
          </div>
          <div
          className="flex flex-col items-center justify-center space-y-5"
          data-aos="fade-up"
